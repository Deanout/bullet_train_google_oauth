...
ActiveRecord::Schema[7.0].define(version: 2023_08_02_061200) do
  ...
  create_table "integrations_google_installations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["oauth_google_account_id"], name: "index_google_installations_on_oauth_google_account_id"
  ...
  create_table "webhooks_incoming_oauth_google_account_webhooks", force: :cascade do |t|
    ...
    t.bigint "oauth_google_account_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["oauth_google_account_id"], name: "index_stripe_webhooks_on_oauth_stripe_account_id"
  end
